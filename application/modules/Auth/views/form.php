...
<html lang="en">
  ...
  <body style="background-image: url(<?php echo base_url('assets/image/pertamina.jpg'); ?>);background-attachment: fixed;background-position: center;background-size: cover;">
	<div class="container">
					...
					<div class="card" style="border-radius: 0">
					  <div class="card-body" style="padding: 21px">
						<div class="text-center">
							<img src="<?php echo base_url('assets/image/logo/Pertamina.png'); ?>" class="img-fluid" alt="logo-sumbawa" style="max-width: 35%" />
						</div>
						<br>
...
<?php
  // echo json_encode($this->session->flashdata('notif'));
