...
<div style="background-color: #FFF; padding: 25px 0;">
	<div class="container">
		<div class="container-konten">
			<div class="row">
				<div class="col-md-8">
					<h1 class="title-header">Daftar Pengaduan</h1><hr>
              ...
              $judul = preg_replace($replace, '-', strtolower($row->judul_pengaduan));
                ...
                <td><?php echo $row->nama_pengadu; ?></td>
								...
								<td>
									<a href="<?php echo site_url('pengaduan/id/'.$row->id.'/'.$judul.'.html'); ?>" class="btn btn-danger btn-block" style="font-size: 11px;border-radius: 0;">Lihat</a>
								</td>
							</tr>
						<?php endforeach; ?>
						</tbody>
					...
					<br>
					<a href="<?php echo site_url('pengaduan'); ?>" class="btn btn-primary" style="border-radius: 0"><i class="fa fa-send" aria-hidden="true"></i> Buat Pengaduan</a>
					<br>
