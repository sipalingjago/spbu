    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <?php
            if($subtitle == 'Pengaturan' || $subtitle == 'Lokasi_pom' || $subtitle == 'Jenis_bbm' | $subtitle== "Tangki" || $subtitle =="Jadwal_shift" || $subtitle =="Nozzel") {
              echo "menu-open";
            }
          ?>
          ">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo site_url('Jenis_bbm'); ?>" class="nav-link <?php echo $subtitle=="Jenis_bbm"?"active":""; ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Jenis BBM</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="<?php echo site_url('Nozzel'); ?>" class="nav-link <?php echo $subtitle=="Nozzel"?"active":""; ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Nozzel</p>
                </a>
              </li>
